		...
		public function prioritas()
		{
			...
			if (isset($_POST['check'])) {
				...
				if ($this->ahp_uji_konsistensi($hasil_tabel_konsistensi)) {
					$this->session->set_flashdata('message2', '<div class="alert alert-danger" role="alert">Silakan cek Nilai konsistensi dipaling bawah dan pastikan nilainya menjadi konsisten!!</div>');
					$i = 0;
					foreach ($data['kriteria'] as $row) {
						$params = array(
							'bobot' => $prioritas[$i++],
